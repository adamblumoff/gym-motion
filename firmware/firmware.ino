...
const uint8_t SENSOR_ODR_CONFIG = 0x05;  // 4 Hz
const uint8_t SENSOR_AMBIENT_AVG_CONFIG = 0x00;  // 8 samples
const uint8_t SENSOR_OBJECT_AVG_CONFIG = 0x01;  // 8 samples
const uint8_t SENSOR_MOTION_PRESENCE_LPF_CONFIG = 0x00;  // ODR/9
const uint8_t SENSOR_MOTION_LPF_CONFIG = 0x02;  // ODR/50
const uint8_t SENSOR_PRESENCE_LPF_CONFIG = 0x02;  // ODR/50
