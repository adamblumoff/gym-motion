  ...
  it("replaces a device snapshot by id and keeps the newest snapshot first", () => {
    const merged = mergeGatewayDeviceUpdate(
      ...
      ],
      {
        ...
        provisioningState: "provisioned",
        updateStatus: "idle",
        updateTargetVersion: "0.5.1",
        updateDetail: null,
        updateUpdatedAt: new Date("2026-03-06T05:01:00.000Z").toISOString(),
        lastHeartbeatAt: null,
        lastEventReceivedAt: null,
        healthStatus: "online",
        gatewayConnectionState: "connected",
        ...
        lastRssi: -40,
        otaStatus: "sending",
        otaTargetVersion: "0.5.1",
        otaProgressBytesSent: 1024,
        otaTotalBytes: 4096,
        otaLastPhase: "sending",
        otaFailureDetail: null,
        otaLastStatusMessage: "Streaming chunks.",
        otaUpdatedAt: new Date("2026-03-06T05:01:00.000Z").toISOString(),
      },
    );
