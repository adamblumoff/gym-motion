...
describe("mergeGatewayDeviceUpdate", () => {
  it("replaces matching devices and keeps newest first", () => {
    const devices = mergeGatewayDeviceUpdate(
      [
        {
          id: "stack-001",
          lastState: "still",
          ...
          advertisedName: "GymMotion-stack-001",
          lastRssi: -50,
          otaStatus: "idle",
      ...
      ],
      {
        ...
        lastSeenAt: 2,
        lastDelta: 12,
        updatedAt: new Date("2026-03-06T05:02:00.000Z").toISOString(),
        hardwareId: "hw-1",
        bootId: "boot-1",
    ...
    expect(devices[0]?.lastState).toBe("moving");
  });
});
